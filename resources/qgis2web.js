...
map.getView().fit([19.837844, -24.213968, 37.815111, -14.516616], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GCF Climate Proofed Irrigation Schemes</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (103 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the distribution and status of the <br />GCF climate proofed irrigation schemes  in Zimbabwe.<br />';
            }
